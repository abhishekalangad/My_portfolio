...
import { IoColorWandOutline, IoBriefcaseOutline } from "react-icons/io5"
            ...
            <div className="services" id='services'>
                <div className="container">
                    ...
                    <motion.div className="services-box" whileInView={fade} initial={{ opacity: 0 }}>
                        ...
                        <div className="services-card">
                            <IoBriefcaseOutline className='services-icon' />
                            <p className='services-title'>ERPNext Solution</p>
                            <p className='services-desc'>I implement ERPNext solutions for businesses to streamline operations, manage resources, and drive efficiency.</p>
                        </div>
                    </motion.div>
                </div>
            </div>
